...
const Notification: React.FC<NotificationProps> = ({ type, title, message, showIcon = true, duration, onClose }) => {
  ...
  return (
    ...
    <motion.div
      ...
      className={`relative w-full max-w-sm rounded-xl p-4 backdrop-blur-xl bg-white/15 dark:bg-gray-950/15 border border-gray-300/60 dark:border-gray-700/60 overflow-hidden ring-1 ring-gray-200/40 dark:ring-gray-700/40 drop-shadow-xl transition-all duration-300 ease-in-out transform hover:scale-105`}
    >
      ...
      <div className="relative z-10 flex items-center space-x-4">
        ...
        <button title='close' onClick={onClose} className="flex-shrink-0 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 transition-colors p-1.5 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800">
