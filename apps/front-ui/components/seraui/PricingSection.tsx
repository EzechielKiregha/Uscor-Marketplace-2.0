				...
				<div className="max-w-7xl mx-auto w-full">
					...
					>
						{pricingTiers.map((tier) => (
							<motion.div
								key={tier.name}
								className={`relative flex flex-col p-6 sm:p-8 rounded-xl border transition-all duration-300 ${
									tier.isPopular
							...
							>
								...
								<ul className="mt-6 sm:mt-8 space-y-3 flex-grow">
								...
								<div className="mt-6 sm:mt-8">
									<motion.button
										className={`glow-button w-full py-3 px-4 rounded-md text-sm sm:text-base font-medium transition-all duration-300 ${
											tier.isPopular
												? ""
