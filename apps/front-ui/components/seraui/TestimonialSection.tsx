...
const TestimonialSection: React.FC<TestimonialSectionProps> = ({
	...
	return (
		<div
			className={`font-inter flex flex-col items-center py-16 px-4 sm:px-6 lg:px-8 text-(--secondary-dark) dark:text-(--lightGray) ${className}`}
		>
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-4 w-full max-w-6xl">
				<div className="bg-card/80 /50 p-8 rounded-xl flex flex-col justify-between border border-(--secondary-light) dark:border-(--secondary-dark) backdrop-blur-sm shadow-md">
					...
					<div className="flex items-center">
						...
						/>
						<div>
							<p className="font-semibold text-(--secondary-dark) dark:text-(--lightGray)">
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
						{testimonials.slice(2).map((testimonial) => (
							<div
								...
								className="bg-card/80 /50 p-6 rounded-xl flex flex-col justify-between border border-(--secondary-light) dark:border-(--secondary-dark) backdrop-blur-sm shadow-md"
							>
