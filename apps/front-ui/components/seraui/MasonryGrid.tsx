...
export const ProductGridItem: React.FC<GridItemProps<Product>> = ({
	item: product,
	onLike,
}) => {
	const [isHovered, setIsHovered] = useState(false);
	const [_imgSrc, _setImgSrc] = useState(product.imageUrl);
	const user = useMe();
...
export const ServiceGridItem: React.FC<GridItemProps<FreelanceService>> = ({
	item: service,
	onLike,
}) => {
	const [isHovered, setIsHovered] = useState(false);
