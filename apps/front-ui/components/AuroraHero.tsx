...
export const AuroraHero = () => {
	...
	return (
		<motion.section
			...
			className="relative grid min-h-screen place-content-center overflow-hidden bg-gray-950 px-4 py-0 text-gray-200"
		>
			<div className="relative z-10 flex flex-col items-center">
				...
				<p className="my-6 max-w-xl text-center text-base leading-relaxed md:text-lg md:leading-relaxed">
					Découvrez des meubles élégants et accessibles qui allient style et
					confort. Uscor-Marketplace vous aide à créer des espaces uniques et
					inspirants.
				</p>
				<motion.button
					style={{
