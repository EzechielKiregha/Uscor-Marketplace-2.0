											...
											<span
												className={`px-2 py-1 rounded-full text-xs ${
													dispute.type === "PAYMENT"
														...
														: dispute.type === "PRODUCT"
															? "bg-warning/10 text-warning"
															: dispute.type === "SERVICE"
											...
											<div className="grid grid-cols-2 gap-4">
												...
												{dispute.compensation > 0 && (
													<div className="border border-orange-400/60 dark:border-orange-500/70 rounded-lg p-4">
														...
														<p className="font-bold">
															${dispute.compensation.toFixed(2)}
														</p>
													</div>
												)}
											</div>
								...
								<div className="border border-orange-400/60 dark:border-orange-500/70 rounded-lg overflow-hidden">
									...
									<div className="p-4 space-y-4">
										...
										<div className="p-3 bg-muted rounded-lg">
											<p className="text-sm">
												<span className="font-medium">Note:</span> Refund
												amounts will be deducted from the business's account.
												Compensation amounts will be paid from platform funds as
												a goodwill gesture.
											</p>
										</div>
									</div>
