  ...
  const handleSuspendUser = async () => {
    ...
    try {
      ...
      showToast(
        "success",
        "Success",
        `${userType} account suspended successfully`,
      );
      onKycVerified();
      onClose();
    } catch (error: any) {
  ...
  const handleActivateUser = async () => {
    ...
    try {
      ...
      showToast(
        "success",
        "Success",
        `${userType} account activated successfully`,
      );
      onKycVerified();
      onClose();
    } catch (error: any) {
              ...
              <div className="p-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      ${user.totalRevenueGenerated.toFixed(2)}
                    </p>
                  </div>
