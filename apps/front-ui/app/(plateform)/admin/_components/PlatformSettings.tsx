				...
				variables: {
					input: {
						...
						minTransactionAmount: parseFloat(
							formData.minTransactionAmount.toString(),
						),
						...
						<div className="bg-muted rounded-lg p-4">
							...
							<div className="mt-4 p-3 bg-background rounded-lg border hover:border-primary ">
								...
								<p className="text-sm text-muted-foreground mt-1">
									This means 1 {formData.tokenSymbol} can be used to purchase $$
									{formData.tokenValue} worth of products or services.
								</p>
							</div>
						</div>
					</div>
						...
						<div className="flex items-start gap-3">
							...
							<div>
								<h3 className="font-semibold">
									East Africa Platform Configuration
								</h3>
								<p className="text-sm text-muted-foreground mt-1">
									USCOR is optimized for the East African market with special
									configurations for mobile money payments, local business
								...
								<div className="mt-3 p-3 bg-background rounded-lg border hover:border-primary ">
									<p className="text-sm">
										...
										(1 uTn = $10) to align with common transaction values in the
										region. Mobile money integration should be enabled for all
