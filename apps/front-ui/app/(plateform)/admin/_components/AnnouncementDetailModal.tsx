							...
							<div className="flex gap-2">
								<Input
									...
									onChange={(e) => {
										...
										const time = formData.scheduledFor
											? formData.scheduledFor.split("T")[1]
											: "00:00";
										setFormData((prev) => ({
											...prev,
							...
							<div className="flex items-start gap-3">
								...
								<div>
									<h3 className="font-semibold">
										East Africa Announcement Tips
									</h3>
									<p className="text-sm text-muted-foreground mt-1">
										When creating announcements for East African users, consider
										the following:
									</p>
									...
									<ul className="mt-2 space-y-1 pl-4">
										<li className="flex items-start gap-2">
											...
											<span>
												Use Swahili or local languages for broader reach in
												certain regions
											</span>
										</li>
										<li className="flex items-start gap-2">
											<CheckCircle className="h-4 w-4 text-success mt-1 flex-shrink-0" />
											<span>
												Mention mobile money payment options prominently
											</span>
										</li>
										<li className="flex items-start gap-2">
											<CheckCircle className="h-4 w-4 text-success mt-1 flex-shrink-0" />
											<span>
												Schedule announcements for morning hours (7-10 AM) for
												maximum visibility
											</span>
										</li>
									</ul>
