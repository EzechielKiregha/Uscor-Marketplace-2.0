// app/worker/inventory/page.tsx (Updated)
'use client';
  ...
  const handleAdjustStock = async () => {
    ...
    if (!isOnline) {
      ...
      const adjustment = {
        ...
        quantity: adjustmentType === 'ADD' ? adjustmentQuantity : -adjustmentQuantity,
      ...
      showToast('info', 'Offline Mode', 'Stock adjustment queued. Will sync when online.');
      ...
      try {
        ...
        showToast('error', 'Error', error.message || 'Failed to adjust inventory');
      }
    }
  };
          ...
          return (
            <div 
              ...
              className={`border rounded-lg overflow-hidden hover:shadow-md transition-shadow ${
                ...
                isLowStock ? 'border-warning/50 bg-warning/5' : 'border-border'
              }`}
            >
      ...
      {filteredInventory.length === 0 && (
        <div className="text-center py-12 bg-card border border-border rounded-lg">
          ...
          <h3 className="text-lg font-medium mb-1">
            {searchQuery || lowStockOnly ? 'No matching items found' : 'No inventory items'}
          </h3>
