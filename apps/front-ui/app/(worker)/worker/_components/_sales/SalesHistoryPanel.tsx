    ...
    <Card className="border hover:border-primary  bg-card">
          ...
          {filteredSales.length === 0 ? (
            ...
            <div className="space-y-3 max-h-75 overflow-y-auto">
              {filteredSales.slice(0, 5).map((sale) => (
                <div
                  key={sale.id}
                  className="border hover:border-primary  rounded-lg p-3 hover:bg-muted/50 cursor-pointer"
      ...
      {selectedSale && (
        <div className="fixed inset-0 bg-background/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-card border hover:border-primary  rounded-lg w-full max-w-2xl overflow-hidden">
            <div className="p-6">
