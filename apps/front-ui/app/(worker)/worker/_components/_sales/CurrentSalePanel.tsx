...
export default function CurrentSalePanel({
  ...
  const [_showModifiers, setShowModifiers] = useState(false);
  ...
  const filteredProducts =
    productsData?.productsByName?.filter(
  ...
  const calculateTotal = useCallback(() => {
    ...
    return (
      currentSaleDetails.saleProducts.reduce(
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            {currentSaleDetails?.id
              ? `ID: ${currentSaleDetails.id.substring(0, 8)}...`
              : "New Sale"}
          </p>
        </div>
              ...
              <div>
                <p className="font-medium text-sm">
                  {(selectedClient || currentSaleDetails?.client)?.fullName ||
                    (selectedClient || currentSaleDetails?.client)?.username ||
                    "Unknown Client"}
                </p>
      ...
      {/* <div className="flex-1 overflow-y-auto p-4">
        {productsLoading ? (
          ...
          <div className="text-center py-8 text-muted-foreground">
            {searchQuery
              ? "No products found"
              : "Start searching to add products to your sale"}
          </div>
        ) : (
      ...
      <div className="border-t border-border p-4">
        <div className="space-y-3">
          ...
          <div className="max-h-40 overflow-y-auto">
            {currentSaleDetails?.saleProducts &&
            currentSaleDetails.saleProducts.length > 0 ? (
                        ...
                        <div>
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              setPaymentDetails({
                                ...paymentDetails,
                                mobileMoneyMethod: e.target.value,
                              })
                            }
                          >
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setPaymentDetails({
                                ...paymentDetails,
                                operatorTransactionId: e.target.value,
                              })
                            }
                          />
                        </div>
          ...
          {paymentMethod && (
            <Button
              ...
              disabled={
                isCompleting || currentSaleDetails?.saleProducts?.length === 0
              }
