			...
			<div className="bg-card border border-border hover:border-primary hover:bg-primary/5 rounded-lg overflow-hidden mb-6">
				...
				<div className="p-4 flex flex-wrap gap-2">
					<Button
						...
						size="sm"
						onClick={() =>
							handleFilterChange("hasLoyalty", !filters.hasLoyalty)
						}
					...
					<Button
						...
						size="sm"
						onClick={() =>
							handleFilterChange("hasPromotions", !filters.hasPromotions)
						}
						className="flex items-center gap-1"
					>
					...
					<Button
						...
						size="sm"
						onClick={() =>
							handleFilterChange("isB2BEnabled", !filters.isB2BEnabled)
						}
						className="flex items-center gap-1"
					>
