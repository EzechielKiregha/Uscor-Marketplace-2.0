		...
		<div className="min-h-screen bg-background">
			<div className="container mx-auto px-4 py-8">
				...
				<div className="grid grid-cols-1 md:grid-cols-4 gap-4 my-6">
					<div className="p-4 bg-card border hover:border-primary  rounded-lg">
					...
					<div className="p-4 bg-card border hover:border-primary  rounded-lg">
						<div className="flex items-center gap-2">
							...
							<div>
								...
								<p className="font-bold text-lg">
									{business.freelanceServices.length}
								</p>
							</div>
						</div>
					</div>
						...
						<div className="bg-card border hover:border-primary  rounded-lg p-4">
							...
							<div className="space-y-2">
								<Button
									...
									className="w-full justify-start"
									onClick={() =>
										(window.location.href = "/businesses?loyalty=true")
									}
								>
									<Star className="h-4 w-4 mr-2" />
								...
								<Button
									...
									className="w-full justify-start"
									onClick={() =>
										(window.location.href = "/businesses?promotions=true")
									}
								>
								...
								<Button
									...
									className="w-full justify-start"
									onClick={() =>
										(window.location.href = "/businesses?b2b=true")
									}
								>
								...
								<Button
									...
									className="w-full justify-start"
									onClick={() =>
										(window.location.href = "/businesses?verified=true")
									}
								>
