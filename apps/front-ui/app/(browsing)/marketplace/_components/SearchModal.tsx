			...
			<div className="bg-card border hover:border-primary  rounded-lg w-full max-w-2xl max-h-[80vh] overflow-y-auto">
				...
				{showResults && (
					<div className="p-4">
						...
						) : !searchData?.searchMarketplace?.products?.length &&
							!searchData?.searchMarketplace?.services?.length ? (
							<div className="text-center py-8">
								<p className="text-muted-foreground">
							...
							<div className="space-y-6">
								...
								{searchData?.searchMarketplace?.products?.length > 0 && (
									<div>
										...
										<div className="space-y-3">
											{searchData.searchMarketplace.products
												.slice(0, 3)
												.map((product: any) => (
													<div
														key={product.id}
								...
								{searchData?.searchMarketplace?.services?.length > 0 && (
									<div>
										...
										<div className="space-y-3">
											{searchData.searchMarketplace.services
												.slice(0, 3)
												.map((service: any) => (
													<div
														key={service.id}
				...
				{!showResults && searchQuery && (
					<div className="p-8 text-center">
						...
						<p className="text-muted-foreground">
							Type to search products and services...
						</p>
					</div>
				)}
			</div>
