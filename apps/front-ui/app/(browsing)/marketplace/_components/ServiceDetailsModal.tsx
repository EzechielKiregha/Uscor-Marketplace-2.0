            ...
            <div className="space-y-6">
              ...
              <div className="border border-orange-400/60 dark:border-orange-500/70 rounded-lg p-4">
                ...
                <div className="mt-4 flex gap-2">
                  ...
                  <Button
                    ...
                    className="flex-1"
                    onClick={() =>
                      (window.location.href = `/b-view/${service.business.id}`)
                    }
                  >
                    View Business
                  </Button>
                ...
                service.workerServiceAssignments.length > 0 && (
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      {service.workerServiceAssignments.map(
                        (assignment: any) => (
                          <div
                            key={assignment.worker.id}
                            className={`border rounded-lg p-3 cursor-pointer transition-all ${
                              selectedWorker === assignment.worker.id
                                ? "border-primary bg-primary/5"
                                : "border-border hover:border-primary/50"
                            }`}
                            onClick={() =>
                              setSelectedWorker(assignment.worker.id)
                            }
                          >
                            <div className="flex items-center gap-3">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1">
                      Before you book, tell us what you need
                    </label>
                    <textarea
                      className="w-full p-2 border border-orange-400/60 dark:border-orange-500/70 rounded-md"
                      rows={3}
              ...
              <div className="mt-6 p-4 bg-muted rounded-lg border border-orange-400/60 dark:border-orange-500/70">
                <div className="flex items-start gap-3">
                  <BriefcaseBusiness className="h-5 w-5 text-primary mt-0.5 shrink-0" />
                  <div>
