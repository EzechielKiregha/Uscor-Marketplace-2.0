...
export default function ServiceCard({ service, viewMode }: ServiceCardProps) {
  ...
  const [createChat, { loading: chatLoading }] = useMutation(CREATE_CHAT, {
    onCompleted: () => {
      showToast(
        "success",
        "Chat Opened",
        "You can now chat with the business about this service",
      );
  ...
  if (viewMode === "grid") {
    return (
      <>
        <div className="border border-orange-400/60 dark:border-orange-500/70 rounded-lg overflow-hidden hover:shadow-md hover:border-orange-400/80 dark:hover:border-orange-500/80 hover:-translate-y-0.5 transition-all duration-200 bg-card">
          {/* Service Image */}
          ...
          <div className="p-4">
            ...
            <div className="flex items-center gap-2 mb-2">
              <div className="w-6 h-6 rounded-full bg-muted flex items-center justify-center text-sm">
                {BusinessTypeIcon({
                  businessType: service.business.businessType,
  ...
  return (
    <>
      <div className="border border-orange-400/60 dark:border-orange-500/70 rounded-lg overflow-hidden hover:shadow-md hover:border-orange-400/80 dark:hover:border-orange-500/80 hover:-translate-y-0.5 transition-all duration-200 bg-card flex flex-col md:flex-row">
        {/* Service Image */}
