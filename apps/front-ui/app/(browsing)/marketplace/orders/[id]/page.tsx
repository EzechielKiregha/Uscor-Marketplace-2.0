...
export default function OrderDetailsPage() {
    ...
    return (
      <div className="max-w-3xl mx-auto p-6">
        <div className="flex items-center justify-between mb-6">
          <Link
            href="/marketplace"
            className="inline-flex items-center text-sm text-gray-600 dark:text-gray-200 hover:text-gray-900"
          >
  ...
  const subtotal = order.products.reduce(
    (sum: number, p: any) => sum + p.product.price * p.quantity,
    0,
  );
                  ...
                  {order.products.map((op: any) => (
                    ...
                    >
                      ...
                      <p className="font-medium">
                        {formatPrice(op.product.price * op.quantity)}
                      </p>
                    </div>
                  ))}
                </div>
