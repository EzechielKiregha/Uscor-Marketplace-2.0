...
const perks = [
  {
    ...
    description:
      "Make the most of your time by enjoying your purchases, quick and reliable delivery right to your doorstep.",
  },
  {
    name: "Affordable Pricing",
    Icon: DollarSign,
    description:
      "We offer high-quality products at prices that respect your budget.",
  },
  {
    name: "Custom Designs",
    Icon: Paintbrush,
    description:
      "Personalize your space with our custom-made products, tailored to your style.",
  },
];
