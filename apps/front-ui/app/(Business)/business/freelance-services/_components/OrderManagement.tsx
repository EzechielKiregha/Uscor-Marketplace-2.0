...
export default function OrderManagement({
	...
	const _handleUpdateOrder = async (orderId: string, status: string) => {
		try {
			await updateOrder({
				variables: {
					id: orderId,
						...
						<div className="p-6">
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
								...
								<div>
									...
									<p className="text-sm text-muted-foreground">
										${selectedOrder.service.rate}{" "}
										{selectedOrder.service.isHourly ? "/hr" : "fixed"}
									</p>
								</div>
							</div>
							...
							<div className="mb-6">
								...
								<div className="space-y-2 p-3 bg-muted rounded-lg">
									...
									<div className="flex justify-between">
										...
										<span>
											${selectedOrder.service.rate}{" "}
											{selectedOrder.service.isHourly ? "/hr" : ""}
										</span>
									</div>
									<div className="flex justify-between">
										<span>Subtotal:</span>
										<span>
											$
											{(
												selectedOrder.service.rate * selectedOrder.quantity
											).toFixed(2)}
										</span>
									</div>
