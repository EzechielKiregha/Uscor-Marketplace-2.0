...
export default function FreelanceServicesPage() {
  ...
  const [activeTab, setActiveTab] = useState<
    "overview" | "management" | "orders" | "workers"
  >("overview");
  ...
  return (
    <div className="space-y-6">
      ...
      {services.length > 0 ? (
        ...
        <div className="text-center py-12 bg-card rounded-lg border hover:border-primary ">
          ...
          <p className="text-muted-foreground mb-6 max-w-md mx-auto">
            Create services to offer to your customers. Perfect for artisans,
            craftsmen, and local businesses to expand their offerings beyond
            physical products.
          </p>
          <Button
            size="lg"
