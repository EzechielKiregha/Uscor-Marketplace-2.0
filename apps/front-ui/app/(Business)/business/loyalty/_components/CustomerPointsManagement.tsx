	...
	const handleAddPoints = async () => {
		...
		try {
			...
			showToast(
				"success",
				"Points Added",
				`${pointsToAdd} points added to ${selectedCustomer.clientName}`,
			);
				...
				{filteredCustomers.length === 0 ? (
					<div className="text-center py-8 text-muted-foreground">
						{searchQuery
							...
							: "No customers enrolled in loyalty program yet"}
					</div>
				) : (
									...
									<div className="space-y-4">
										<div className="flex items-center gap-2">
											<Button
												...
												size="icon"
												onClick={() =>
													setPointsToAdd(Math.max(0, pointsToAdd - 10))
												}
											>
							...
							<div className="space-y-6">
								...
								<div className="flex justify-end gap-3 pt-4 border-t border-border">
									...
									<Button
										...
										disabled={
											pointsToRedeem < 100 ||
											pointsToRedeem > (selectedCustomer?.totalPoints || 0)
										}
									>
