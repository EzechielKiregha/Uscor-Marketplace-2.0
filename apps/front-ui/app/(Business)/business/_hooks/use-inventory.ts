...
export const useInventory = (storeId: string, businessId?: string) => {
	...
	const [createInventoryAdjustmentMutation] = useMutation(
		CREATE_INVENTORY_ADJUSTMENT,
	);
	...
	const createPurchaseOrder = useCallback(
		...
		[createPurchaseOrderMutation, showToast],
	);
	...
	const createTransferOrder = useCallback(
		...
		[createTransferOrderMutation, showToast],
	);
	...
	const createInventoryAdjustment = useCallback(
		...
		[createInventoryAdjustmentMutation, refetchInventory, showToast],
	);
