...
export default function PricingPlans({}: PricingPlansProps) {
	...
	const { data: pricingUpdateData, loading: pricingUpdateLoading } =
	...
	const handlePlanChange = async (planId: string) => {
		...
		try {
			...
			showToast(
				"error",
				"Error",
				error.message || "Failed to update pricing plan",
			);
		} finally {
			setIsChanging(false);
					...
					<div className="flex items-start gap-3">
						...
						<div className="flex-1">
							<h3 className="font-semibold">
								Current Plan: {currentPlan?.name || "Basic"}
							</h3>
								...
								<div className="p-6 space-y-5">
									{plan.isYearly && plan.name !== "BASIC" && (
										<div className="flex items-center gap-2 p-2 bg-success/10 text-success rounded-md">
											...
											<span className="text-sm">
												Save ${yearlySavings.toFixed(2)} annually
											</span>
										</div>
									)}
									...
									<div>
										...
										<ul className="space-y-2">
											{PLAN_FEATURES[
												plan.name.toUpperCase() as keyof typeof PLAN_FEATURES
											].map((feature, index) => (
									...
									<div>
										<Button
											...
											className="w-full"
											onClick={() =>
												!plan.isCurrentPlan && handlePlanChange(plan.id)
											}
								...
								{plan.name === "PRO" && (
									<div className="px-6 pb-6">
										<div className="p-3 bg-muted rounded-lg">
											<p className="text-sm">
												<span className="font-medium">Pro Tip:</span> For most
												local businesses in East Africa, the PRO plan offers the
												best value with marketplace access at an affordable
												price.
											</p>
										</div>
									</div>
				...
				<div className="mt-6 border border-orange-400/60 dark:border-orange-500/70 rounded-lg p-4">
					...
					<ul className="space-y-2">
						<li className="flex items-start gap-2">
							...
							<span>
								Upgrade to PRO to access the freelance services marketplace for
						...
						<li className="flex items-start gap-2">
							<CheckCircle className="h-4 w-4 text-success mt-1 flex-shrink-0" />
							<span>
								With PRO or ENTERPRISE, you can purchase materials from other
						...
						<li className="flex items-start gap-2">
							<CheckCircle className="h-4 w-4 text-success mt-1 flex-shrink-0" />
							<span>
								Advanced inventory management helps wood workers and artisans
						...
						<li className="flex items-start gap-2">
							<CheckCircle className="h-4 w-4 text-success mt-1 flex-shrink-0" />
							<span>
								Loyalty programs (PRO and above) help build customer
								relationships for local businesses
							</span>
						</li>
					</ul>
					...
					<div className="mt-4 p-3 bg-muted rounded-lg">
						<p className="text-sm">
							<strong>Pro Tip:</strong> For local artisans and craftsmen, the
							PRO plan is often the best value as it unlocks the marketplace
							features while providing advanced tools for managing your craft
							business.
						</p>
					</div>
				</div>
					...
					<div className="divide-y divide-border">
						<div className="p-4">
							...
							<p className="text-sm text-muted-foreground">
								...
								will take effect at the beginning of your next billing cycle.
							</p>
						</div>
						...
						<div className="p-4">
							...
							<p className="text-sm text-muted-foreground">
								Yes, all plans except BASIC offer annual billing with a 20%
						...
						<div className="p-4">
							...
							<p className="text-sm text-muted-foreground">
								We accept all major credit cards, mobile money (MTN, Airtel,
								Orange, M-Pesa), and bank transfers. For East African
								businesses, mobile money is the preferred payment method.
							</p>
						</div>
						...
						<div className="p-4">
							...
							<p className="text-sm text-muted-foreground">
								Yes, all new businesses get a 14-day free trial of the PRO plan
						...
						<div className="p-4">
							...
							<p className="text-sm text-muted-foreground">
								We automatically convert your local currency to USD for billing.
								You'll be charged in your local currency via mobile money or
								card. All pricing shown is in USD equivalent.
							</p>
						</div>
					</div>
				</div>
				...
				<div className="mt-6 border border-orange-400/60 dark:border-orange-500/70 rounded-lg p-4 bg-muted">
					...
					<div className="space-y-3">
						<div>
							...
							<p className="text-sm text-muted-foreground">
								Our pricing is displayed in USD for consistency, but you'll be
								charged in your local currency:
							</p>
							<ul className="mt-2 space-y-1 pl-4 list-disc text-sm text-muted-foreground">
								<li>
									<span className="font-medium">Rwanda:</span> 1 USD ≈ 1,100 RWF
								</li>
								<li>
									<span className="font-medium">Uganda:</span> 1 USD ≈ 3,700 UGX
								</li>
								<li>
									<span className="font-medium">Kenya:</span> 1 USD ≈ 130 KES
								</li>
								<li>
									<span className="font-medium">Tanzania:</span> 1 USD ≈ 2,300
									TZS
								</li>
							</ul>
						</div>
						...
						<div>
							...
							<p className="text-sm text-muted-foreground">
								For East African businesses, we support direct billing via
								mobile money:
							</p>
							<ul className="mt-2 space-y-1 pl-4 list-disc text-sm text-muted-foreground">
						...
						<div>
							<h4 className="font-medium mb-1">
								Special Offers for East Africa
							</h4>
							<p className="text-sm text-muted-foreground">
							...
							<ul className="mt-2 space-y-1 pl-4 list-disc text-sm text-muted-foreground">
								...
								<li>
									Free hardware setup consultation for PRO and ENTERPRISE plans
								</li>
