...
export const DOCUMENT_TYPES = [
  {
    ...
    description:
      "Official document showing your business is legally registered",
    required: true,
...
export default function KycVerification({}: KycVerificationProps) {
  ...
  const { data: kycUpdateData, loading: kycUpdateLoading } = useSubscription(
    ON_KYC_UPDATED,
    {
      variables: { businessId: user?.id },
      skip: !user?.id,
  ...
  const handleDownloadSample = (sampleUrl: string) => {
    ...
    showToast(
      "info",
      "Sample Document",
      "This would download a sample document to show the required format",
    );
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
              {DOCUMENT_TYPES.map((document) => {
                ...
                return (
                  <div
                    key={document.id}
                    className={`border border-orange-400/60 dark:border-orange-500/70 rounded-lg p-4 ${
                      status === "VERIFIED"
                        ? "bg-success/5"
                        : status === "PENDING"
                          ? "bg-warning/5"
                      ...
                      <div className="flex flex-col sm:flex-row gap-2 min-w-[180px]">
                        ...
                        {(status === "PENDING" ||
                          ...
                          <Button
                            ...
                            onClick={() =>
                              handleRemoveDocument(documentData?.id)
                            }
                          >
                            <X className="h-4 w-4" />
                          </Button>
          ...
          <div className="border border-orange-400/60 dark:border-orange-500/70 rounded-lg p-4">
            ...
            <div className="mt-4 p-3 bg-muted rounded-lg">
              <p className="text-sm">
                <strong>Pro Tip:</strong> For local wood workers and artisans,
                having a verified business profile makes it easier to purchase
                materials from other businesses and offer your services to a
                wider audience.
              </p>
            </div>
          </div>
          ...
          <div className="border border-orange-400/60 dark:border-orange-500/70 rounded-lg p-4 bg-muted">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Requirements may vary slightly by country in East Africa.
                  Below are general guidelines:
                </p>

                <ul className="mt-2 space-y-1 pl-4 list-disc">
                  <li>
                    <span className="font-medium">Rwanda:</span> Business
                    registration, tax ID, and proof of address are mandatory
                  </li>
                  <li>
                    <span className="font-medium">Uganda:</span> Business
                    registration, tax PIN, and owner's national ID required
                  </li>
                  <li>
                    <span className="font-medium">Kenya:</span> Certificate of
                    incorporation, KRA PIN, and business permit needed
                  </li>
                  <li>
                    <span className="font-medium">Tanzania:</span> Business
                    license, tax identification, and owner's ID required
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  KYC verification typically takes 1-3 business days in East
                  Africa. During busy periods, it may take up to 5 business
                  days. Make sure to submit your documents well in advance of
                  when you need full marketplace access.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="mt-2 space-y-1 pl-4 list-disc text-sm text-muted-foreground">
                  ...
                  <li>
                    Proof of address is outdated (must be within last 3 months)
                  </li>
