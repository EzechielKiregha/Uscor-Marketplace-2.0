...
export default function Preferences({ businessT }: PreferencesProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    businessType: businessT,
  });
  const [isSubmitting, setIsSubmitting] = useState(false);
  const [showBusinessTypeModal, setShowBusinessTypeModal] = useState(false);
  const { showToast } = useToast();

  const { data: businessTypesData, loading: businessTypesLoading } =
  ...
  useEffect(() => {
    if (businessData) {
      setFormData({
        ...
        language: "en",
        timeZone:
          businessData?.country === "RWANDA"
            ? "Africa/Kigali"
            : businessData?.country === "UGANDA"
              ? "Africa/Kampala"
              : businessData?.country === "KENYA"
                ? "Africa/Nairobi"
                : businessData?.country === "TANZANIA"
                  ? "Africa/Dar_es_Salaam"
                  : businessData?.country === "DRC"
                    ? "Africa/Kinshasa"
                    : businessData?.country === "BURUNDI"
                      ? "Africa/Bujumbura"
                      : "Africa/Kigali",
        businessType: businessData?.businessType || businessT,
      });
    }
  }, [
    businessData?.businessType,
    businessData?.isB2BEnabled,
          ...
          <div>
            <div className="flex justify-between items-start mb-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Control how your business appears and operates in the
                  marketplace
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4 pl-2 border-l border-border">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Make your business visible to other businesses in the
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="font-medium">
                    Allow Messaging from Other Businesses
                  </h4>
                  <p className="text-sm text-muted-foreground">
                    Enable other businesses to send you messages about products
                    and services
                  </p>
                </div>
                <Switch
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Africa/Kampala">
                      Kampala, Uganda (GMT+3)
                    </option>
                    <option value="Africa/Nairobi">
                      Nairobi, Kenya (GMT+3)
                    </option>
                    <option value="Africa/Dar_es_Salaam">
                      Dar es Salaam, Tanzania (GMT+3)
                    </option>
                    <option value="Africa/Kinshasa">
                      Kinshasa, DRC (GMT+1)
                    </option>
                    <option value="Africa/Bujumbura">
                      Bujumbura, Burundi (GMT+2)
                    </option>
                  </select>
                </div>
              </div>
            ...
            <div className="bg-card border hover:border-primary  rounded-lg w-full max-w-2xl">
              <div className="p-6">
                ...
                <div className="mt-6 p-4 bg-muted rounded-lg">
                  <p className="text-sm">
                    <strong>Why is business type important?</strong> Your
                    business type determines the features and recommendations
                    you see in the app. It helps us provide relevant tips and
                    optimize your experience for your specific business needs.
                  </p>
                </div>
              </div>
            </div>
