    ...
    const form = useForm<FormData>({
        ...
        values: meBusiness
            ? {
                  ...
                  isB2BEnabled: (meBusiness as any)?.isB2BEnabled ?? false,
                  hasAgreedToTerms:
                      (meBusiness as any)?.hasAgreedToTerms ?? false,
                  preferences: (meBusiness as any)?.preferences || {},
              }
            : undefined,
    });
    ...
    const renderStepContent = () => {
            ...
            return (
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-8">
                        ...
                        >
                            <Store
                                className={`h-8 w-8 mx-auto mb-3 ${!isServiceMode ? "text-primary" : "text-muted-foreground"}`}
                            />
                            <h4
                                className={`font-semibold ${!isServiceMode ? "text-foreground" : "text-foreground"}`}
                            >
                                Sell Products
                            </h4>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                        {(isServiceMode ? serviceTypes : businessTypes).map(
                            (type) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <Icon
                                            className={`h-6 w-6 mb-2 ${isSelected ? "text-white" : "text-muted-foreground group-hover:text-primary"}`}
                                        />
                                        <h4
                                            className={`font-medium text-sm ${isSelected ? "text-white" : "text-foreground"}`}
                                        >
                                            {type.label}
                                        </h4>
                                    </button>
        ...
        if (step === 2) {
            const selectedChannels =
                (preferences.salesChannels as string[]) || [];
            return (
                <div className="space-y-6">
                    <div className="text-center mb-8">
                        <h3 className="text-2xl font-bold text-foreground mb-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {salesChannels.map((channel) => {
                            ...
                            return (
                                ...
                                >
                                    <div
                                        className={`p-2 rounded-lg ${isSelected ? "bg-primary/20" : "bg-card/50 dark:bg-white/5"}`}
                                    >
                                        <Icon
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 gap-3">
                        {businessMaturityOptions.map((option) => {
                            ...
                            const isSelected =
                                preferences.businessMaturity === option.value;
                            return (
                                <button
                                    key={option.value}
                                    type="button"
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        <h4
                                            className={`font-semibold ${isSelected ? "text-foreground" : "text-foreground"}`}
                                        >
                                            {option.label}
                                        </h4>
            ...
            return (
                <div className="space-y-6">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-muted-foreground">
                            We make it easy to migrate to USCOR
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {platformOptions.map((option) => {
                            const Icon = option.icon;
                            const isSelected =
                                preferences.currentPlatform === option.value;
                            return (
                                <button
                                    key={option.value}
                                    type="button"
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {options.map((option) => {
                            const Icon = option.icon;
                            const isSelected =
                                preferences.productOrServiceType ===
                                option.value;
                            return (
                                <button
                                    key={option.value}
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            {revenueRanges.map((option) => {
                                const isSelected =
                                    preferences.revenueRange === option.value;
                                return (
                                    <button
                                        key={option.value}
                                        type="button"
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                            {employeeCountOptions.map((option) => {
                                const isSelected =
                                    preferences.employeeCount === option.value;
                                return (
                                    <button
                                        key={option.value}
                                        type="button"
                                    ...
                                    >
                                        ...
                                        />
                                        <span
                                            className={`text-xs font-medium ${isSelected ? "text-foreground" : "text-foreground"}`}
                                        >
                                            {option.label}
                                        </span>
                                    </button>
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 gap-3">
                        {growthExpectations.map((option) => {
                            const Icon = option.icon;
                            const isSelected =
                                preferences.growthExpectation === option.value;
                            return (
                                <button
                                    key={option.value}
                                    type="button"
        ...
        if (step === 8) {
            const selectedPayments =
                (preferences.paymentMethods as string[]) || [];
            return (
                <div className="space-y-6">
                    <div className="text-center mb-8">
                        <h3 className="text-2xl font-bold text-foreground mb-2">
                    ...
                    <div className="mt-6 p-4 rounded-xl bg-gradient-to-r from-primary/10 to-accent/10 border border-primary/20">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-muted-foreground mt-1">
                                    USCOR seamlessly integrates with M-Pesa, MTN
                                    Mobile Money, Airtel Money, and Orange Money
                                    ...
                                    <FormControl>
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-12 pr-4 bg-muted/50 dark:bg-white/5 border border-border dark:border-white/10 rounded-xl px-4 py-3 text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:border-primary/50 transition-all duration-300"
                                            />
                                        </div>
                                    </FormControl>
                                    <FormMessage />
            ...
            return (
                <div className="space-y-6">
                    ...
                    <div className="bg-gradient-to-br from-card/50 to-card/80 dark:from-white/5 dark:to-white/10 border border-border dark:border-white/10 rounded-2xl p-6 space-y-4">
                        ...
                        <div className="space-y-3">
                            ...
                            <ReviewRow
                                label="Revenue Range"
                                value={
                                    preferences.revenueRange || "Not specified"
                                }
                            />
                            <ReviewRow
                                label="Team Size"
                                value={
                                    preferences.employeeCount || "Not specified"
                                }
                            />
                            <ReviewRow
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem className="flex items-start gap-3 p-4 rounded-xl bg-card/50 dark:bg-white/5 border border-border dark:border-white/10">
                                <FormControl>
                                    <button
                                        type="button"
                                        onClick={() =>
                                ...
                                <div className="flex-1">
                                    <FormLabel className="text-foreground text-sm font-medium">
                                        I agree to the USCOR Terms of Service
                                        and Privacy Policy
                                    </FormLabel>
                                    <p className="text-xs text-muted-foreground mt-1">
                                        By continuing, you agree to our terms
                                        and conditions for using the platform.
                                    </p>
                                </div>
                            </FormItem>
                        )}
    ...
    return (
        <div className="relative w-full min-h-screen bg-background flex overflow-hidden">
            ...
            <div className="relative w-full flex min-h-screen">
                ...
                <div className="hidden lg:flex lg:w-1/2 relative flex-col justify-between p-12 xl:p-16 border-r border-border">
                    {/* Content */}
                    <div className="relative z-10">
                        ...
                        <div className="mt-16 space-y-6">
                            ...
                            <p className="text-lg text-muted-foreground max-w-md leading-relaxed">
                                Join thousands of SMEs across East Africa. From
                                Kigali to Nairobi, manage operations, accept
                                mobile money, and grow your customer base.
                            </p>
                    ...
                    <div className="w-full max-w-2xl relative z-10">
                        ...
                        <div className="text-center mb-8">
                            ...
                            <p className="text-muted-foreground text-sm">
                                ...
                                {step === 4 &&
                                    "Are you already selling elsewhere?"}
                                {step === 5 &&
                                    (isFreelance
                                ...
                                {step === 8 &&
                                    "Choose payment options for your customers"}
                                {step === 9 &&
                            ...
                            >
                                ...
                                <div className="flex gap-3 pt-6 border-t border-border dark:border-white/10">
                                    <GlowButton
                                        ...
                                        onClick={handleBack}
                                        disabled={step === 1}
                                        className="flex-1 h-12 rounded-xl bg-card/50 dark:bg-white/5 border border-border dark:border-white/10 text-foreground font-semibold hover:bg-card dark:hover:bg-white/10 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                                    >
                        ...
                        <div className="mt-12 text-center">
                            <p className="text-xs text-muted-foreground/60">
                                © 2025 USCOR. Empowering East African
                                Businesses.
                            </p>
                        </div>
                    </div>
