...
export default function BusinessCreatePage() {
  ...
  const [_signInBusiness, { loading: businessLoading }] = useMutation(
  ...
  const _businessTypeFromStorage =
  ...
  const _business = businessData?.data?.business;
  ...
  return (
    <div className="relative w-full flex items-center justify-center min-h-screen bg-background ">
      <div className="w-full max-w-lg p-6 space-y-6 bg-card  rounded-lg border border-secondary-light dark:border-secondary-dark shadow-lg">
        {/* Progress */}
        <div>
            ...
            {step === 4 && (
              <div className="space-y-4">
                ...
                <p className="text-sm opacity-80">
                  Review your info and finish setup. You can edit later in
                  Business Settings.
                </p>
              </div>
            )}
