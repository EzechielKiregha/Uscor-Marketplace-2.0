...
export default function SettingsPanel({ client }: SettingsPanelProps) {
	...
	const _handleProfileInputChange = (
	...
	const _handleProfileSelectChange = (
												...
												<Button
													...
													onClick={() => {
														...
														showToast(
															"info",
															"Not Implemented",
															"Payment method deletion would happen here",
														);
													}}
												>
													<Trash2 className="h-4 w-4" />
											...
											{paymentForm.type === "MOBILE_MONEY" ? (
												<div>
													...
													<p className="mt-1 text-xs text-muted-foreground">
														Enter your mobile money number when you make a
														payment
													</p>
												</div>
											) : (
							...
							<div className="flex items-start gap-3">
								...
								<div>
									<h3 className="font-semibold">
										Payment Methods in East Africa
									</h3>
									<p className="text-sm text-muted-foreground mt-1">
										Mobile money is the preferred payment method across East
										Africa. We support all major mobile money providers for
									...
									<div className="mt-3 p-3 bg-background rounded-lg border border-border hover:border-primary hover:bg-primary/5">
										<p className="text-sm">
											...
											East African businesses, mobile money is the fastest and
											most convenient payment option. You'll receive an USSD
											code to complete your payment after placing an order.
										</p>
									</div>
								</div>
							</div>
