                  ...
                  <div className="mt-4">
                    ...
                    <div className="relative">
                      ...
                      <div className="relative flex justify-between">
                        <div
                          className={`flex flex-col items-center ${deliveryStatus.step >= 0 ? "text-primary" : "text-muted-foreground"}`}
                        >
                          <div
                            className={`w-8 h-8 rounded-full flex items-center justify-center mb-2 ${
                              deliveryStatus.step >= 0
                        ...
                        <div
                          className={`flex flex-col items-center ${deliveryStatus.step >= 1 ? "text-primary" : "text-muted-foreground"}`}
                        >
                          <div
                            className={`w-8 h-8 rounded-full flex items-center justify-center mb-2 ${
                              deliveryStatus.step >= 1
                                ? "bg-primary text-primary-foreground"
                                : "bg-border"
                            }`}
                          >
                        ...
                        <div
                          className={`flex flex-col items-center ${deliveryStatus.step >= 2 ? "text-primary" : "text-muted-foreground"}`}
                        >
                          <div
                            className={`w-8 h-8 rounded-full flex items-center justify-center mb-2 ${
                              deliveryStatus.step >= 2
                                ? "bg-primary text-primary-foreground"
                                : "bg-border"
                            }`}
                          >
                        ...
                        <div
                          className={`flex flex-col items-center ${deliveryStatus.step >= 3 ? "text-primary" : "text-muted-foreground"}`}
                        >
                          <div
                            className={`w-8 h-8 rounded-full flex items-center justify-center mb-2 ${
                              deliveryStatus.step >= 3
                                ? "bg-primary text-primary-foreground"
                                : "bg-border"
                            }`}
                          >
                  ...
                  <div className="border border-border hover:border-primary hover:bg-primary/5 rounded-lg overflow-hidden">
                    ...
                    <div className="p-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            {activeOrder.paymentMethod
                              ? `${activeOrder.paymentMethod.type} •••• ${activeOrder.paymentMethod.last4}`
                              : "Mobile Money"}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="mt-4 p-3 bg-muted rounded-lg">
                        <p className="text-sm">
                          <span className="font-medium">Note:</span> For mobile
                          money payments, the transaction is completed when you
