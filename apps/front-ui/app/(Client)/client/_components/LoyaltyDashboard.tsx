...
export default function LoyaltyDashboard({ client }: LoyaltyDashboardProps) {
	...
	const [_redeeming, setRedeeming] = useState<string | null>(null);
	...
	const currentTier =
		program.tiers.find((tier: any) => client.loyaltyPoints >= tier.minPoints) ||
		program.tiers[0];
					...
					<div className="bg-muted rounded-lg p-4">
						...
						<div className="mt-4">
							<div className="flex justify-between text-sm text-muted-foreground mb-1">
								...
								<span>
									{client.loyaltyPoints} / {currentTier.minPoints}
								</span>
							</div>
					...
					<div className="bg-muted rounded-lg p-4">
						...
						<ul className="space-y-2">
							<li className="flex items-start gap-2">
								...
								<span>
									Earn {program.pointsPerDollar} point
									{program.pointsPerDollar === 1 ? "" : "s"} for every $1 spent
								</span>
							</li>
							<li className="flex items-start gap-2">
								<ArrowRight className="h-4 w-4 text-primary mt-1 flex-shrink-0" />
								...
								>
									...
									<p className="text-sm text-muted-foreground mb-3">
										{isCurrentTier
											...
											: isNextTier
												? "Next tier benefits (only {tier.minPoints - client.loyaltyPoints} points away!)"
										...
										<div className="pt-3 border-t border-border">
											<p className="text-sm">
												...
												<span className="font-medium">
													{tier.minPoints - client.loyaltyPoints}
												</span>{" "}
