...
export default function Reviews({ client }: ReviewsProps) {
	...
	const _totalReviews = reviewsData?.clientReviews?.total || 0;
				...
				{reviews.length === 0 ? (
					<div className="text-center py-12">
						...
						<p className="text-muted-foreground mb-6">
							You haven't left any reviews yet. Share your experience with
							...
							onClick={() => {
								...
								if (businesses.length > 0) {
									...
									showToast(
										"info",
										"No Businesses",
										"You need to make a purchase before leaving a review",
									);
								}
							}}
						>
					...
					<div className="flex items-start gap-3">
						...
						<div>
							...
							{activeBusiness === "business1" && (
								<p className="text-sm text-muted-foreground mt-1">
									For bookstore reviews, mention specific books you purchased
									and how helpful the staff was in finding what you needed.
									Teachers and students should note if educational materials met
									their requirements.
								</p>
							)}
							...
							{activeBusiness === "business2" && (
								<p className="text-sm text-muted-foreground mt-1">
									When reviewing cafes, mention the quality of coffee, service
									speed, and atmosphere. Note if they accommodated special
									requests like "no sugar" or specific brewing methods.
								</p>
							)}

							{activeBusiness === "business3" && (
								<p className="text-sm text-muted-foreground mt-1">
									For hardware stores, review the knowledge of staff, quality of
									tools, and availability of specific items. Mention if they
									helped with project planning or provided expert advice.
								</p>
							)}

							{!activeBusiness && (
								<p className="text-sm text-muted-foreground mt-1">
									Your reviews help other customers make informed decisions. Be
									specific about what you liked and any areas for improvement.
									Businesses value your feedback and often respond to reviews.
								</p>
							)}
						</div>
					</div>
