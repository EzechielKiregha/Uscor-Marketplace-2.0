		...
		return (
			<div className="bg-card border border-orange-400/60 dark:border-orange-500/70 rounded-lg p-6">
				<div className="text-center py-12">
					...
					<p className="text-muted-foreground mb-6">
						We'll start showing personalized recommendations after you've made a
						few purchases.
					</p>
						...
						<div className="bg-muted rounded-lg p-4">
							<div className="flex flex-col md:flex-row md:items-start gap-4">
								<div className="md:w-48">
									{filteredRecommendations[0].items[0].media &&
									filteredRecommendations[0].items[0].media.length > 0 ? (
										<img
								...
								<div className="flex-1">
									...
									<div className="mt-3 flex flex-wrap gap-2">
										{filteredRecommendations[0].items
											.slice(0, 2)
											.map((item: any) => (
												<div
													key={item.id}
													className="flex items-center gap-2 bg-background border border-orange-400/60 dark:border-orange-500/70 rounded px-2 py-1"
												>
										...
										{filteredRecommendations[0].items.length > 2 && (
											<span className="text-sm text-muted-foreground">
												+{filteredRecommendations[0].items.length - 2} more
												items
											</span>
										)}
									</div>
										...
										<Button
											...
											onClick={() => {
												...
												showToast(
													"success",
													"Redirecting",
													"Taking you to recommended items",
												);
											}}
										>
													...
													<Button
														...
														onClick={() => {
															showToast(
																"success",
																"Redirecting",
																"Taking you to recommended products",
															);
														}}
													>
														View
													...
													<Button
														...
														onClick={() => {
															showToast(
																"success",
																"Redirecting",
																"Taking you to recommended services",
															);
														}}
													>
														Book Now
													...
													<Button
														...
														onClick={() => {
															showToast(
																"success",
																"Redirecting",
																"Taking you to business profile",
															);
														}}
													>
														View Profile
					...
					<div className="flex items-start gap-3">
						...
						<div>
							...
							<p className="text-sm text-muted-foreground mt-1">
								...
								browsing behavior, and preferences to suggest products,
								services, and businesses you might like. The more you use Uscor,
							...
							<div className="mt-3 p-3 bg-background rounded-lg border border-orange-400/60 dark:border-orange-500/70">
								<p className="text-sm">
									...
									previous purchases. Teachers and students get personalized
									recommendations for classroom resources.
								</p>
							</div>
						</div>
					</div>
