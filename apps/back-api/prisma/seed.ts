...
import { Country, PrismaClient } from "../src/generated/prisma/client";
...
const hardwareItems = [
	...
	},
	{
		...
		model: "TM-m30",
		type: "printer",
		description: "Small footprint receipt printer",
	...
	},
	{
		...
		model: "XP-Q800",
		type: "printer",
		description: "Reliable quality at a low price",
	...
	},
	{
		...
		model: "TSP143IIIU",
		type: "printer",
		description: "USB communication with iPad charging",
	...
	},
	{
		...
		model: "CT-E651ET",
		type: "printer",
		description: "Stylish, high-performance 3-inch receipt printer",
	...
	},
	{
		...
		model: "SP-POS890",
		type: "printer",
		description: "High speed receipt printer with auto cutter",
	...
	},
	{
		...
		model: "SM-T300i",
		type: "mobile-printer",
		description: "Portable mobile Bluetooth thermal receipt printer",
	...
	},
	{
		...
		model: "MP-B20",
		type: "mobile-printer",
		description: "Compact and ultra-lightweight mobile printer",
	...
	},
	{
		...
		model: "ZD410",
		type: "label-printer",
		description: "Designed for the smallest of workspaces",
	...
	},
	{
		...
		model: "CS3070",
		type: "scanner",
		description: "Tiny device for batch scanning",
	...
	},
	{
		...
		model: "QW2100",
		type: "scanner",
		description: "Small, lightweight and ergonomic",
	...
	},
	{
		...
		model: "Z-3250",
		type: "scanner",
		description: "Compact scanner with wireless communication",
	...
	},
	{
		...
		model: "Volcora-16",
		type: "cash-drawer",
		description: '16" Drawer 5 Bill / 6 Coin Tray',
	...
	},
	{
		...
		model: "Sunmi",
		type: "terminal",
		description: "Uscor compatible terminal with built-in printer",
	...
	},
	{
		...
		model: "BOXaPOS-stand",
		type: "stand",
		description: "Spacing for a compact printer",
		image: "/images/hardware/boxapos-small-stand.jpg",
	},
	{
		title: "Kensington Adjustable Kickstand",
		model: "Kensington-kickstand",
		type: "stand",
		description: "Makes typing and viewing easier",
...
const businessTypes = [
	{
		name: "Retail",
		description: "Stores selling physical products",
	},
	{
		name: "Service",
	...
	{
		name: "Artisan",
		description: "Handmade goods and creators",
	},
	{
		name: "Wholesale",
		description: "Bulk sellers and distributors",
	},
];
...
async function seedPricingPlans() {
	...
	for (const tier of pricingTiers) {
		...
		const existingFeatures = await prisma.pricingFeature.findMany({
...
async function seedHardwareRecommendations() {
	...
	for (const country of countriesToSeed) {
		for (const item of hardwareItems) {
			...
			const existing = await prisma.hardwareRecommendation.findFirst({
				where: { model: item.model, country },
			});
			if (!existing) {
				...
				await prisma.hardwareRecommendation.update({
					where: { id: existing.id },
					data: {
						description: item.description,
						setupGuideUrl: item.image,
