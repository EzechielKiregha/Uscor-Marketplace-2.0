...
export class InventoryResolver {
	...
	@Subscription(() => TransferOrderEntity, {
		filter: (payload, variables) => {
			return (
				payload.transferOrderCreated.fromStoreId === variables.storeId ||
	...
	@Subscription(() => TransferOrderEntity, {
		filter: (payload, variables) => {
			return (
				payload.transferOrderUpdated.fromStoreId === variables.storeId ||
