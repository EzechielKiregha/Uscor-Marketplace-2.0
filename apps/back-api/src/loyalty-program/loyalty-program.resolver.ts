...
export class LoyaltyResolver {
  ...
  async createLoyaltyProgram(
    ...
    const program =
      await this.loyaltyService.createLoyaltyProgram(
        input,
        context.req.user,
      )
  ...
  async updateLoyaltyProgram(
    ...
    const program =
      await this.loyaltyService.updateLoyaltyProgram(
        id,
        input,
        context.req.user,
      )
  ...
  async createPointsTransaction(
    ...
    return this.loyaltyService.createPointsTransaction(
      input,
      context.req.user,
    )
  }
  ...
  async getLoyaltyProgramById(
    ...
    return this.loyaltyService.getLoyaltyProgramById(
      id,
      context.req.user,
    )
  }
  ...
  async earnPoints(
    ...
    this.pubSub.publish('pointsEarned', {
      ...
      businessId:
        transaction.loyaltyProgram.business.id,
    })
  ...
  async deleteLoyaltyProgram(
    ...
    const program =
      await this.loyaltyService.getLoyaltyProgramById(
        id,
        context.req.user,
      )
    if (!program) {
