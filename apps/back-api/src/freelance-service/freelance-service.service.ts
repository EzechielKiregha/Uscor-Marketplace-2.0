...
export class FreelanceServiceService {
	...
	async create(
		...
		const { title, description, isHourly, rate, category, workerIds } =
	...
	async findAll(filters: FindAllFilters) {
		...
		if (
			category &&
			Object.values(FreelanceServiceCategory).includes(
	...
	async update(
		...
		const { title, description, isHourly, rate, workerIds } =
	...
	async assignWorkerToService(input: AssignWorkersInput, businessId: string) {
