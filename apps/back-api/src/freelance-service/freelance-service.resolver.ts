...
export class FreelanceServiceResolver {
	...
	@Mutation(() => FreelanceServiceEntity, {
		description: "Creates a new freelance service.",
	})
	...
	@Query(() => PaginatedFreelanceServicesResponse, {
		...
		description: "Retrieves freelance services with pagination and filters.",
	})
	...
	@Query(() => FreelanceServiceEntity, {
		...
		description: "Retrieves a single freelance service by ID.",
	})
	...
	async updateFreelanceService(
		...
		const user = context.req.user;
		const service = await this.freelanceServiceService.update(
			id,
			input,
			user.id,
		);
	...
	@Mutation(() => WorkerServiceAssignmentEntity, {
		description: "Assigns a worker to a freelance service.",
	})
	...
	@Query(() => [WorkerServiceAssignmentEntity], {
		...
		description: "Get worker assignments for a service or worker.",
	})
	...
	freelanceServiceCreated(@Args("businessId") _businessId: string) {
	...
	freelanceServiceUpdated(@Args("businessId") _businessId: string) {
