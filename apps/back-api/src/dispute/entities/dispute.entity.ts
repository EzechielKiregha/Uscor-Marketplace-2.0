...
export class DisputeMessageEntity {
	...
	senderId?: string;
	@Field(() => ClientEntity || BusinessEntity || WorkerEntity, {
		nullable: true,
	})
	sender?: ClientEntity | BusinessEntity | WorkerEntity;
}
...
export class DisputeEntity {
	...
	reporter?: ClientEntity | BusinessEntity | WorkerEntity;
