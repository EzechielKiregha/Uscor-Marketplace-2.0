import { Resolver, Query, Args, Int, Context, Subscription, Mutation } from '@nestjs/graphql';
...
export class ProductResolver {
  ...
  @UseGuards(JwtAuthGuard, RolesGuard)
  @Roles('business')
  @Mutation(() => MediaEntity, { description: 'Adds media to a product.' })
  ...
  @UseGuards(JwtAuthGuard, RolesGuard)
  @Roles('business')
  @Mutation(() => MediaEntity, { description: 'Removes media from a product.' })
  async removeProductMedia(
    ...
    if (!media) throw new NotFoundException("No media found");
  ...
  productCreated(@Args('businessId') businessId: string) {
  ...
  productUpdated(@Args('businessId') businessId: string) {
