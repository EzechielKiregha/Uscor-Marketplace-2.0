...
import {
    ...
    PaginatedWorkerReportsEntity,
    PaginatedWorkerSalesHistoryEntity,
...
export class WorkerResolver {
  ...
  async createWorker(
    ...
    return await this.workerService.create(
      createWorkerInput,
    )
  }
  ...
  @Query(() => PaginatedWorkerReportsEntity, {
    name: 'workerReports',
  })
  async getWorkerReports(
    ...
    return this.workerService.getWorkerReports(
      workerId,
      storeId,
      timeRange,
      reportType,
  ...
  async getWorkerPerformance(
    ...
    return this.workerService.getWorkerPerformance(
      workerId,
      storeId,
      timeRange,
    )
  ...
  @Query(
    () => PaginatedWorkerSalesHistoryEntity,
    { name: 'workerSalesHistory' },
  )
  async getWorkerSalesHistory(
    @Args('workerId', { type: () => String })
    workerId: string,
    @Args('storeId', {
      type: () => String,
    ...
    return this.workerService.getWorkerSalesHistory(
      workerId,
      storeId,
      timeRange,
      status,
  ...
  async getWorkerDashboard(
    ...
    return this.workerService.getDashboard(
      workerId,
      storeId,
    )
  }
  ...
  async getWorkerDashboardStats(
    ...
    return this.workerService.getDashboardStats(
      workerId,
      storeId,
    )
  }
  ...
  async createSale(
    ...
    const sale =
      await this.workerService.createSale(input)
  ...
  async getWorkerCurrentSale(
    ...
    return this.workerService.getCurrentSale(
      workerId,
      storeId,
    )
  }
  ...
  async addSaleProduct(
    ...
    return this.workerService.addSaleProduct(
      input,
    )
  }
  ...
  async updateSaleProduct(
    ...
    return this.workerService.updateSaleProduct(
      id,
      input,
    )
  }
  ...
  async removeSaleProduct(
    ...
    return this.workerService.removeSaleProduct(
      id,
    )
  }
  ...
  async completeWorkerSale(
    ...
    const sale =
      await this.workerService.completeSale({
        id,
  ...
  async createInventoryAdjustment(
    ...
    const adjustment =
      await this.workerService.createInventoryAdjustment(
        input,
      )
  ...
  async startShift(
    @Args('input') input: StartShiftInput,
  ) {
    const shift =
      await this.workerService.startShift(input)
  ...
  @Roles('worker')
  @Mutation(() => ShiftEntityWorker)
  async endWorkerShift(
    @Args('input') input: EndWorkerShiftInput,
  ) {
    const shift =
      await this.workerService.endShift(input)
  ...
  async getWorkerCurrentShift(
    ...
    return this.workerService.getCurrentShift(
      workerId,
      storeId,
    )
  }
  ...
  async getWorkerChats(
    ...
    return this.workerService.getChatsByWorker(
      workerId,
      page,
      limit,
    )
  ...
  async processMobileMoneyPayment(
    ...
    return this.workerService.processMobileMoneyPayment(
      input,
    )
  }
  ...
  newChatMessage(
    @Args('workerId') _workerId: string,
  ) {
    return this.pubSub.asyncIterableIterator([
      'newChatMessage',
    ])
  ...
  @Subscription(
    () => InventoryAdjustmentEntityWorker,
    {
      filter: (payload, variables) =>
        payload.inventoryUpdated.storeId ===
        variables.storeId,
    },
  )
  inventoryUpdated(
    @Args('storeId') _storeId: string,
  ) {
    return this.pubSub.asyncIterableIterator([
      'inventoryUpdated',
    ])
