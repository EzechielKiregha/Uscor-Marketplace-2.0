...
export class ChatResolver {
  ...
  async createChat(
    ...
    if (
      !createChatInput.participantIds.includes(
        user.id,
      )
    ) {
      throw new Error(
        'Users must include themselves as a participant',
      )
    }
  ...
  async getChatsByParticipant(
    ...
    return this.chatService.getChatsByParticipant(
      participantId,
    )
  }
  ...
  async getChatNotifications(
    ...
    return this.chatService.getChatNotifications(
      userId,
    )
  }
  ...
  async startNegotiation(
    ...
    const chat =
      await this.chatService.startNegotiation(
        input,
      )
  ...
  async acceptNegotiation(
    ...
    const updatedChat =
      await this.chatService.acceptNegotiation(
        negotiationId,
      )
